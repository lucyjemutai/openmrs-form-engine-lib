...
export const getInitialValueFromObs = (field: FormField, obsGroup: any) => {
...
export const RepeatingField: React.FC<FormFieldProps> = ({ question, onChange }) => {
  const [questions, setQuestions] = useState([question]);
  const { fields, encounterContext, obsGroupsToVoid } = React.useContext(FormContext);
